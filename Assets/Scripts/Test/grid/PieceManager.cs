...
public class PieceManager : MonoBehaviour
{
    ...
    public void SpawnWhitePieces()
    {
        ...
        {
            var randomPrefab = GetRandomUnit<WhitePieces>(GridSceneFaction.White);
    ...
    public void SpawnBlackPieces()
    {
        ...
        {
            var randomPrefab = GetRandomUnit<BlackPieces>(GridSceneFaction.Black);
    ...
    private T GetRandomUnit<T>(GridSceneFaction gridSceneFaction) where T : Piece
    {
        return (T) _pieces.Where(
            u => u.gridSceneFaction == gridSceneFaction
            )
            .OrderBy(
                o => Random.value
                )
